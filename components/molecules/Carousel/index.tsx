...
export const Carousel: React.FC = (props) => {
  return (
    <Card className="relative block items-center md:flex">
      ...
      <div className="flex h-full w-full items-center rounded-lg md:w-3/5">
        <div className="p-12 md:py-12 md:pr-24 md:pl-16">
      ...
      <button className="focus:shadow-outline absolute top-0 left-0 mt-32 -ml-6 h-8 w-8 rounded-full bg-white text-2xl text-indigo-600 shadow-md hover:text-indigo-400 focus:text-indigo-400 focus:outline-none">
        <ArrowLeftIcon />
      </button>
      <button className="focus:shadow-outline absolute top-0 right-0 mt-32 -mr-6 h-8 w-8 rounded-full bg-white text-2xl text-indigo-600 shadow-md hover:text-indigo-400 focus:text-indigo-400 focus:outline-none">
        <ArrowRightIcon />
      </button>
    </Card>
  );
